...
class ConstrainedGenerationMixin(GenerationMixin):
    ...
    @torch.no_grad()
    def generate(
            self, dynamic_vocab_cache=None, target_type=None,
            inputs: Optional[torch.Tensor] = None,
            next_token_mapping=None, set_all_labels=None,
            tokenizer=None,
        ...
        if is_greedy_gen_mode:
            ...
            # 12. run beam search
            return ConstrainedGenerationMixin.beam_search(self, dynamic_vocab_cache,
                                                          input_ids,
                                                          beam_scorer, next_token_mapping=next_token_mapping,
    ...
    def beam_search(
            ...
            next_token_mapping=None, target_type=None, tokenizer=None, set_all_labels=None,
        ...
        while True:
            ...
            if target_type is None or target_type == "dfs":
                next_token_logits = constrained_generation_dfs(dynamic_vocab_cache, input_ids, next_token_logits,
                                                               next_token_mapping, tokenizer)
            elif target_type == "bfs":
                next_token_logits = constrained_generation_bfs(dynamic_vocab_cache, input_ids, next_token_logits,
                                                               next_token_mapping, set_all_labels, tokenizer,
                                                               )
